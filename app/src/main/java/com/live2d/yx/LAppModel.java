...
import com.live2d.utils.android.BufferUtil;
import com.live2d.utils.android.FileManager;
import com.live2d.utils.android.ModelSetting;
import com.live2d.utils.android.ModelSettingJson;
import com.live2d.utils.android.OffscreenImage;
...
//			mainMotionManager.setMotionDebugMode(true);
	...
	public void startMotionByNo(String name ,int priority, int no)
	{
		int max=modelSetting.getMotionNum(name);
		if (no > max) {
			no = max;
