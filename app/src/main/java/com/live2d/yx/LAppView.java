...
import com.live2d.utils.android.AccelHelper;
import com.live2d.utils.android.TouchManager;
...
//		if( accelHelper.getShake() > 1.5f )		//监听摇晃，做出反应
//		{
...
//		}
	...
	public void touchesMoved(float p1x,float p1y,float p2x,float p2y)
	{
		...
		if(LAppDefine.DEBUG_TOUCH_LOG)Log.v(TAG, "view  dx:"+dx+" dy:"+dy+" cx:"+cx+" cy:"+cy+" scale_in:"+scale);
